...
class Config {
    ...
    generate_browser_source_url() {
        ...
        browser_string += `<strong>DISABLE &nbsp &rarr; &nbsp</strong> Shutdown source when not visible.<br><br>`;
        browser_string += `<strong>DISABLE &nbsp &rarr; &nbsp</strong> Refresh browser when scene becomes active.`;
